    ...
    <section className="hero-section select-none relative w-full ">
      <div className="hero-wrapper w-full flex flex-col lg:flex-row justify-between ">
        <div className="hero-content   xl:px-32 xl:pt-32  md:px-12 md:pt-[66px] pt-24 px-4">
          ...
          <button className="flex md:text-[28px] items-center justify-evenly text-white xl:mt-12 md:h-[76px] md:w-[300px] text-[22px] font-bold mb-7 w-64 h-[65px]  bg-gradient-tangerine-diagonal rounded-[100px] relative z-10">
            Start Exploring{" "}

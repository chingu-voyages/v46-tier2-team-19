...
export const RecipeDetails = ({ recipe }) => {
  return (
    <div className="page-wrapper bg-sky">
      ...
      <div className="p-5 page-body md:p-8 md:pt-0 xl:p-10 md:grid md:grid-cols-4 md:grid-rows-10 md:gap-10">
        <Card className="intro-card md:col-start-2 md:col-end-5">
          <div className="flex-row-reverse gap-4 intro-wrapper md:flex">

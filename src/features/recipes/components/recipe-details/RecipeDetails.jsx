  ...
  return (
    <div className="page-wrapper bg-sky">
      ...
      <div className="page-body p-5 md:p-8 md:pt-0 xl:p-10 md:grid md:grid-cols-4 md:grid-rows-10 md:gap-10">
        <Card className="intro-card md:col-start-1 md:col-end-5 xl:col-start-2 md:row-start-3 xl:row-start-1">
        ...
        <Card className="quick-links-card flex flex-col xl:col-end-2 md:col-start-1 md:col-end-3 md:row-start-1 md:row-end-3 md:flex md:[&_.card]:my-0">
        ...
        <RecipeVideo
          ...
          className="xl:col-start-1 xl:col-end-2 xl:row-start-3 md:row-start-1 md:col-start-3 md:col-end-5"
        />
        <Card className="difficulty-card md:col-start-3 md:col-end-5 md:row-start-2 xl:col-start-2">
          <RecipeDifficultyCard tags={recipe.tags} />
        </Card>
        <Card
          className="ingredients-card md:col-start-1 md:col-end-5 xl:row-start-3 xl:row-end-5 xl:col-start-2 xl:col-end-5"
          id="ingredients"
        >
          <IngredientSections sections={recipe.sections} />
        </Card>
        <Card
          className="instructions-card md:col-start-1 md:col-end-5 xl:col-start-2 xl:col-end-5"
          id="preparation"
        >
        ...
        <Card
          id="nutrition"
          className="md:col-start-1 md:col-end-5 xl:col-start-2 xl:col-end-5"
        >
        ...
        <Card
          id="tips"
          className="xl:align-self-start md:col-start-1 md:col-end-5 xl:col-start-1 xl:col-end-2 xl:row-start-4 xl:row-end-6"
        >

    ...
    return (
      <Card className="intro-card md:col-start-1 md:col-end-13 md:row-start-3 lg:col-start-5 lg:row-start-1 2xl:col-start-4">
        <div className="intro-wrapper flex-row-reverse gap-4 md:flex">
          <div>
            <div className="picture-wrapper -mx-6 max-h-[20rem] overflow-hidden -mt-6 mb-4 box-content flex justify-center md:overflow-visible md:rotate-12 md:rounded-full md:border-[.5rem] border-b-[.3rem] border-dashed border-tangerine-500 pb-6 md:-mr-20 md:-mt-16 md:h-[17rem] md:w-[17rem] md:p-3 xl:h-[25rem] xl:max-h-[25vw] xl:w-[25rem] xl:max-w-[25vw]">

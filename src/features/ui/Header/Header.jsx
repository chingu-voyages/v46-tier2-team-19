...
export const Header = () => {
  ...
  return (
    <header className="top-0 z-40 flex items-center justify-between h-16 px-4 bg-white shadow-sm site-header shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8 rounded-t-2xl">
      <Link to="/">
        <aside>
